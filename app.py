...
def create_app() -> Flask:
    ...
    # ── Background Storage Daemon ──────────────────────────────────────────
    try:
        from services.voice_service import start_audio_cleanup_daemon
        start_audio_cleanup_daemon()
    except Exception as e:
        logger.error(f"Failed to start audio cleanup daemon: {e}")
