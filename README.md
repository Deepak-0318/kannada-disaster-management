...
Ensure you have native Python 3.11 or 3.13 installed on macOS, or Python 3.11+ on other platforms. On macOS, Python 3.14 may fail because `faster-whisper` pulls `av` and there is no compatible prebuilt wheel for ARM64 / FFmpeg 8.

If you are on macOS, install FFmpeg first:
